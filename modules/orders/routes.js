...
router.get('/customers', requireRole('super_admin', 'company_admin', 'inventory_manager', 'viewer'), customerController.list);
router.get('/customers/:id', requireRole('super_admin', 'company_admin', 'inventory_manager', 'viewer'), customerController.getById);
